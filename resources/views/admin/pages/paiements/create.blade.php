    ...
    <div class="content-wrapper">
        <div class="d-xl-flex justify-content-between align-items-start">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.paiement.gie.index') }}">Paiements</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mb-4">Paiement de Gie {{ $demande->company }}</h4>
                        <form action="{{ route('admin.paiement.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="text-right">
                                    ...
                                    <a href="{{ route('admin.paiement.gie.index') }}" class="btn btn-danger">Retour</a>
                                </div>
                            </div>
                        </form>
                    </div>

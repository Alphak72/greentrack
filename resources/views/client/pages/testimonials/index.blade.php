                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">
                           <a href="{{ route('temoignage.create') }}" class="btn btn-primary">Ajouter</a>
                        </div>
                                ...
                                @if ($testimonials->count() > 0)
                                    @foreach ($testimonials as $key => $testimonial)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('temoignage.edit', ['id' => $testimonial->id]) }}" class="btn btn-sm btn-primary">
                                                    <i class="mdi mdi-pencil" style="font-size: 1rem"></i>
                                                </a>
                                                <a href="{{ route('temoignage.delete', ['id' => $testimonial->id]) }}" class="btn btn-sm btn-danger" onclick="return(confirm('Vous etes sur le point de supprimer un element.'))">
